...
>>>>>>> ee74b8830cb297b692f5d45d1018fa97f309ae47
    ...
    if print_images:
        if task=="generate_train":
            ...
            # params = dict(top =1,bottom=0,left=0,right=1)
            # fig.subplots_adjust(**params)


            ylims_depth = [0,1]#ax[1].get_ylim()#[0.0,1.0]#ax[1].get_ylim()#
            xlims_depth = [0,1]#ax[1].get_xlim()#[0.0,1.0]#ax[1].get_xlim()#

            ylims_rgb = [0,1]#ax[0].get_ylim()#[0.0,1.0]#ax[0].get_ylim()#
            xlims_rgb = [0,1]#ax[0].get_xlim()#[0.0,1.0]#ax[0].get_xlim()#


            # print("Printing lims for depth and rgb --V")
            # print(xlims_depth,ylims_depth,xlims_rgb,ylims_rgb)
            ...
            # rgb_width, rgb_height = ax[0].get_size_inches()*fig.dpi
            # depth_width, depth_height = ax[1].get_size_inches()*fig.dpi

            # bbox_depth = ax[1].get_window_extent().transformed(fig.dpi_scale_trans.inverted())
